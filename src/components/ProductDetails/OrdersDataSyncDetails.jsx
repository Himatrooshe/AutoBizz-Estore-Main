      ...
      <div className="max-w-[1400px] flex flex-col lg:flex-row lg:gap-8 gap-6 w-full">
        ...
        <div className="w-full lg:flex-1">
          ...
          <div className="block lg:hidden mt-6">
            <ProductInfoCard
              title="Orders Data Sync"
              headerTitle="One-Time Purchase, Lifetime Convenience"
              description={
                <>
                  For just <strong>$128</strong>, simplify your Shopify order
                  management. Our{" "}
        ...
        <ProductInfoCard
              ...
              description={
                <>
                  For just <strong>$160</strong>, simplify your Shopify order
                  management. Our{" "}
                  <strong>Orders Data Sync Google App Script</strong>{" "}
                  automatically updates your Shopify orders in Google Sheets every
                  hour, saving you from the hassle of manual exports.
