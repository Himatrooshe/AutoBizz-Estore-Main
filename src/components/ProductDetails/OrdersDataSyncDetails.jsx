...
import Details from "./DescriptionAndDetails/OrderDetails";
import Description from "./DescriptionAndDetails/OrderDecstiption";

const OrderDataSyncDetails = () => {
  ...
  // Handle screen resizing for product carousel
  useEffect(() => {
    const handleResize = () => {
...
export default OrderDataSyncDetails;
