      ...
      <div className="max-w-[1400px] w-full flex flex-col lg:flex-row gap-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <div className="w-[400px] lg:sticky lg:top-0 lg:hidden mx-auto pl-3">
              <nav className="text-xs sm:text-sm text-gray-500 mb-4 font-semibold hidden lg:block">
                Home / Product Path /{" "}
                <span className="text-[#1c5a7a]">Orders Data Sync</span>
              </nav>

              <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">
                One-Time Purchase, Lifetime Convenience
              </h1>
              <p className="text-gray-600 mb-6 text-sm sm:text-base">
                For just $160, simplify your Shopify order management. Our{" "}
                <strong>Orders Data Sync Google App Script</strong>{" "}
                automatically updates your Shopify orders in Google Sheets every
                hour, saving you from the hassle of manual exports.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              {activeTab === "description" && (
                <div>
                  ...
                  <ul className="text-gray-600 pl-5 space-y-2">
                    <li>
                      ✔ <strong>Orders Data Synced Every Hour:</strong> Keep
                      your Shopify orders updated in real time on Google Sheets
                      with our one-time purchase Google App Script.
                    </li>
                    <li>
                      ✔ <strong>API Integration:</strong> Seamlessly connect
                      Shopify and Google Sheets for smooth, reliable data
                      transfer.
                    </li>
                    <li>
                      ✔ <strong>Data Cleanup and Formatting:</strong>{" "}
                      Automatically organize and format your data, ensuring it’s
                      always neat and ready for analysis.
                    </li>
                    <li>
                      ✔ <strong>Source Code Included:</strong> Full access to
                      the script lets you customize it to meet your specific
                      needs.
                    </li>
                    <li>
                      ✔ <strong>Efficient Shopify Workflow Automation:</strong>{" "}
                      Simplify order tracking and reporting with minimal effort.
                    </li>
                    <li>
                      ✔ <strong>Delivery Within 3 Days:</strong> We will provide
                      the script within just three days.
                    </li>
                    <li>
                      ✔ <strong>2 Revisions Included:</strong> Adjust and refine
                      the script to fit your exact requirements.
                    </li>
                  </ul>
                </div>
              )}
              {activeTab === "details" && (
                <div>
                  ...
                  <ul className="text-gray-600 pl-5 space-y-2">
                    <li>
                      ✔ Shopify store owners who want real-time order tracking
                      without manual work.
                    </li>
                    <li>
                      ✔ Businesses looking to automate order data exports for
                      faster reporting and decision-making.
                    </li>
                    <li>
                      ✔ Anyone frustrated by the repetitive task of exporting
                      Shopify orders manually.
                    </li>
                    <li>
        ...
        <div className="lg:w-[470px] lg:sticky lg:top-0 hidden lg:block">
          ...
          <p className="text-gray-600 mb-6">
            For just $160, simplify your Shopify order management. Our{" "}
            <strong>Orders Data Sync Google App Script</strong> automatically
            updates your Shopify orders in Google Sheets every hour, saving you
            from the hassle of manual exports.
          </p>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            <div className="flex items-center space-x-4 mb-4">
              <span className="text-4xl font-bold text-[#1c5a7a]">$160</span>
