  ...
  return (
    <div className="flex justify-center bg-[#DBEAFE] py-20">
      <div className="max-w-[1400px] w-full flex flex-col lg:flex-row gap-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <div className="w-[400px] lg:sticky lg:top-0 lg:hidden mx-auto pl-3">
              <nav className="text-xs sm:text-sm text-gray-500 mb-4 font-semibold hidden lg:block">
                <Link to="/">Home </Link>/ Product Path /{" "}
                <span className="text-[#1c5a7a]">
              ...
              <p className="text-gray-600 mb-6 text-sm sm:text-base">
                ...
                for any platform—whether it's <strong>eCommerce</strong>,{" "}
                <strong>CRM</strong>, or <strong>PM tools</strong>. Let us
                design and build your streamlined process automation to optimize
                your operations and drive results.
              </p>
              ...
              {activeTab === "details" && (
                <div>
                  <h3 className="text-gray-800 font-bold text-xl mb-4">
                    Book Your Free Demo – No Pressure, Just Solutions
                  </h3>
                  <p>
                    Demos are <strong>completely free</strong> and come with
                    <strong>no pressure</strong> our goal is simply to
                    understand your business needs. We’ll take the time to learn
                    about the systems you currently have in place, showcase how
                    our solutions work, and explore if there’s an opportunity
                    for us to collaborate and help you achieve your goals.
                    Whether you’re looking to automate workflows, integrate
                    third-party tools, or streamline operations, we’re here to
                    help you get the most out of your systems.{" "}
                    <strong>Book your free consultation today</strong>, and
                    let’s see how we can drive real results for your business!
                  </p>
                </div>
              )}
              {activeTab === "review" && (
        ...
        <div className="lg:w-[470px] sticky top-0 hidden lg:block">
          ...
          <p className="text-gray-600 mb-6">
            Looking for a solution that fits your unique business needs? We
            specialize in creating <strong>customized automation</strong> for
            any platform—whether it's <strong>eCommerce</strong>,{" "}
            <strong>CRM</strong>, or <strong>PM tools</strong>. Let us design
            and build your streamlined process automation to optimize your
