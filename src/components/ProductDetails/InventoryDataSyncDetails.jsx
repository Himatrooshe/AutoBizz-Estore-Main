...
import ProductDataSync from "../ProductCart/ProductDataSync";
    ...
    <div className="flex justify-center bg-[#DBEAFE] py-20">
      <div className="max-w-[1400px] w-full flex flex-col lg:flex-row gap-10">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <div className="w-[400px] lg:sticky lg:top-0 lg:hidden mx-auto pl-3">
              <nav className="text-xs sm:text-sm text-gray-500 mb-4 font-semibold hidden lg:block">
                Home / Product Path /{" "}
                <span className="text-[#1c5a7a]">Inventory Data Sync</span>
              </nav>
              ...
              <p className="text-gray-600 mb-6 text-sm sm:text-base">
                ...
                Script syncs your Shopify inventory data, including stock
                levels, inventory locations, and variant updates, directly to
                Google Sheets every hour. Say goodbye to manual tracking
                forever.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              {activeTab === "description" && (
                <div>
                  ...
                  <ul className="text-gray-600 pl-5 space-y-2">
                    <li>
                      • <strong>Hourly Order Data Sync:</strong> Get your
                      Shopify orders data synced every hour into Google Sheets
                      without lifting a finger.
                    </li>
                    <li>
                      • <strong>No Subscriptions, Just Results:</strong> With no
                      repetitive fees, this one-time purchase ensures lifetime
                      automation and savings.
                    </li>
                    <li>
                      • <strong>Save Time & Reduce Errors:</strong> Manual
                      exports are prone to mistakes. Automation keeps your order
                      data accurate and up-to-date.
                    </li>
                    <li>
                      •{" "}
                      <strong>Simplifies Shopify Inventory Management:</strong>{" "}
                      Updates your inventory data, including product quantities
                      and location-wise stock levels, in Google Sheets
                      automatically.
                    </li>
                    <li>
                      • <strong>Real-Time Stock Tracking:</strong> Monitor stock
                      levels and inventory changes in Shopify without delays or
                      manual exports.
                    </li>
                    <li>
                      • <strong>Error-Free Inventory Sync:</strong> Minimize
                      mistakes by automating the transfer of critical inventory
                      data.
                    </li>
                    <li>
                      • <strong>Handles Large Product Catalogs:</strong> Manage
                      inventory for thousands of SKUs and variants effortlessly.
                    </li>
                    <li>
                      • <strong>Affordable Solution:</strong> A one-time payment
                      of $180 provides lifetime automation.
                    </li>
                  </ul>

                  <p className="text-gray-800 font-bold text-xl mt-6 mb-4">
                    Key Features
                  </p>
                  <ul className="text-gray-600 pl-5 space-y-2">
                    <li>
                      ✔ <strong>Automated Shopify Inventory Management:</strong>
                      Automatically pull stock counts, SKU availability, and
                      product variant inventory.
                    </li>
                    <li>
                      ✔ <strong>Accurate Shopify Inventory Management:</strong>
                      Track inventory adjustments, low-stock alerts, and
                      restocking in real time.
                    </li>
                    <li>
                      ✔ <strong>Connect Shopify API to Google Sheets:</strong>
                      Use the Shopify Admin API for effortless and automated
                      inventory updates.
                    </li>
                    <li>
                      ✔
                      <strong>Track Inventory Changes Across Locations:</strong>
                      Manage multi-location stock data directly in Google
                      Sheets.
                    </li>
                    <li>
                      ✔ <strong>Quick Setup & Delivery:</strong> Delivered in 10
                      days with 4 revisions to ensure smooth operation.
                    </li>
                  </ul>
                </div>
              )}
              {activeTab === "details" && (
                <div>
                  ...
                  <ul className="text-gray-600 pl-5 space-y-2">
                    <li>
                      ✔ Store owners looking to optimize their Shopify inventory
                      management system.
                    </li>
                    <li>
                      ✔ Businesses managing multi-location Shopify inventory
                      data.
                    </li>
                    <li>
                      ✔ Anyone dealing with frequent inventory changes and large
                      product catalogs.
                    </li>
                    <li>
        ...
        <div className="lg:w-[470px] lg:sticky lg:top-0 hidden lg:block">
          <nav className="text-sm text-gray-500 mb-4 font-semibold hidden lg:block">
            <Link
              to="/"
          ...
          <p className="text-gray-600 mb-6">
            For just <strong>$180</strong>, revolutionize your{" "}
            <strong>Shopify inventory management</strong> . Our Google App
            Script syncs your Shopify inventory data, including stock levels,
            inventory locations, and variant updates, directly to Google Sheets
            every hour. Say goodbye to manual tracking forever.
          </p>
