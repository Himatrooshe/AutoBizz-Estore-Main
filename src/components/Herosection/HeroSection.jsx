      ...
      <div className="container mx-auto flex flex-col-reverse xl:flex-row items-center">
        <div className="w-full xl:w-2/3 text-center 4xl:text-left mt-6 md:mt-0">
          ...
          <div className="flex flex-wrap justify-center 4xl:justify-start 2xl:justify-start xl:justify-start gap-6">
            <div className="bg-[#F5F8F9] p-4 sm:p-6 rounded-lg shadow-sm text-center 4xl:w-[307px] 2xl:w-[307px] xl:w-[307px] lg:w-[307px] md:w-[307px] w-[100%] transition-transform transform hover:scale-105 hover:shadow-lg">
          ...
          <div className="flex flex-wrap items-center justify-center 4xl:justify-start 2xl:justify-start xl:justify-start gap-6 mt-6">
            <div className="flex flex-col md:flex-row items-center bg-[#f5f8f9] rounded-lg p-5 md:w-[410px] w-full transition-transform transform hover:scale-105 hover:shadow-lg">
            ...
            <div className="flex items-center justify-center bg-[#f5f8f9] rounded-lg shadow-sm p-4 space-x-4 4xl:w-auto 2xl:w-auto xl:w-auto lg:w-auto md:w-auto w-full transition-transform transform hover:scale-105 hover:shadow-lg">
