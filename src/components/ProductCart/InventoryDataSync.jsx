...
const ProductCard = () => {
  ...
  const [popup, setPopup] = useState(false); // Add popup state
  ...
  return (
    <div className="4xl:w-[426px] h-[760px] md:w-[340px] rounded-[40px] shadow-lg bg-[#F5F8F9] p-6 flex flex-col justify-between transition-transform transform hover:scale-105 hover:shadow-lg">
      <div>
        <Link to="/inventory-data-sync-details">
          <img
        ...
        <p className="text-gray-600 text-sm mt-2 font-semibold">
          ...
          <strong> One-Time Purchase, Lifetime Automation.</strong> Take control
          of your inventory and boost efficiency today!
        </p>
      </div>
