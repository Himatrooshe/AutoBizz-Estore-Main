      ...
      <div className="mt-auto">
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center space-x-1">
            <span className="text-[20px] sm:text-[26px] font-bold text-[#1c5a7a]">
              ${product.price}
            </span>
            <span className="text-[16px] sm:text-[20px] font-normal text-red-500">
